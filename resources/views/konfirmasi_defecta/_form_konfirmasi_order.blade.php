<form id="form-konfirm-order" class="validated_form">
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {!! Form::select('id_suplier_order', $supliers, null, ['id'=>'id_suplier_order', 'class' => 'form-control input_select']) !!}
                        </div>
                ...
                <div class="card-footer">
                    <button class="btn btn-success" type="button" onClick="submit_order()" data-toggle="tooltip" data-placement="top" title="Simpan"><i class="fa fa-save"></i> Simpan</button>

                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            {!! Form::text('harga_dokter', $detail->harga_dokter, array('id' => 'harga_dokter','class' => 'form-control required', 'placeholder'=>'Harga')) !!}
                        </div>
                        <div class="form-group col-md-2">
...
<script type="text/javascript">
    ...
    function set_detail_new(obj, no){
        harga_dokter = $("#harga_dokter").val();
        jumlah = $("#jumlah").val();
        total = parseFloat(harga_dokter) * parseFloat(jumlah);
        var total_rp = hitung_rp(total);
        $("#harga_dokter_"+no).val(harga_dokter);
        $("#jumlah_"+no).val(jumlah);
        $("#hitung_total_"+no).data("total", total);
        $("#hitung_total_"+no).val(total);
        $("#harga_dokter_"+no).html(harga_dokter);

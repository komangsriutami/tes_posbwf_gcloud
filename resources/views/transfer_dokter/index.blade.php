...
@section('title')
Data Transfer Dokter
@endsection

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="#">Transaksi</a></li>
    <li class="breadcrumb-item"><a href="#">Data Transfer Dokter</a></li>
...
@section('content')
    ...
    <div class="card card-info card-outline mb-12 border-left-primary">
        <div class="card-body">
            ...
            <a class="btn btn-success w-md m-b-5" href="{{url('transfer_dokter/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form role="form" id="searching_form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 form-group">
                        <label>Dokter</label>
                        <select class="form-control input_select" id="id_dokter" name="id_dokter">
                            <option value=""> --- Pilih Dokter ---</option>
                            @foreach($dokters as $obj)
            ...
            <table  id="tb_data_transfer" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th width="40%" class="text-center">Dokter</th>
                        <th width="10%" class="text-center">Total</th>
                        <th width="17%" class="text-center">Lunas ?</th>
...
<script type="text/javascript">
    ...
    var tb_data_transfer = $('#tb_data_transfer').DataTable( {
        ...
        scrollX: true,
        ajax: {
            url: '{{url("transfer_dokter/list_transfer_dokter")}}',
                data:function(d){
                    d.id         = $('#search_id').val();
    ...
    function delete_transfer(id){
        ...
        function(){
            $.ajax({
                type: "POST",
                url: '{{url("transfer_dokter/hapus_nota")}}/'+id,
                async:true,
                data: {
                    _token:token,
                    id:id
    ...
    function cetak_nota(id){
        $.ajax({
            type: "POST",
            url: '{{url("transfer_dokter/cetak_nota")}}',
            async:true,
            data: {
                _token:"{{csrf_token()}}",
                id:id
            ...
            $("#modal-xl .modal-title").html("Cetak Nota Transfer Dokter");
            $('#modal-xl').modal("show");
    ...
    function export_data_transfer(){
        window.open("{{ url('transfer_dokter/export') }}"+ "?id="+$('#search_id').val()+"&id_dokter="+$('#id_dokter').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
@endsection
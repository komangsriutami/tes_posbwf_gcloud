...
@section('content')
	...
	<div class="card card-info card-outline mb-12 border-left-primary">
	    <div class="card-body">
			...
			<a class="btn btn-success w-md m-b-5" href="{{url('suplier/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
	    </div>
	</div>
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_suplier" class="table table-bordered table-striped table-hover">
                <thead>
                    <tr>
                        <th>No.</th>
                        <th>Kode</th>
        ...
        function(){
            $.ajax({
                ...
                success:  function(data){
                    if(data==1){
                        swal("Deleted!", "Data suplier berhasil dihapus.", "success");
                    }else{
                        
                        swal("Failed!", "Gagal menghapus data suplier.", "error");
                    }
                },
                complete: function(data){
                    tb_suplier.fnDraw(false);
                },
                error: function(data) {
    ...
    function submit_valid(id){
        ...
        if(status) {
            ...
            $.ajax({
                ...
                success:  function(data){
                    if(data.status ==1){
                        show_info("Data suplier berhasil disimpan...");
    ...
    function edit_data(id){
        $.ajax({
            ...
            beforeSend: function(data){
                ...
                $("#modal-xl .modal-title").html("Edit Data - Suplier");
                $('#modal-xl').modal("show");

...
@section('content')
	...
	<div class="card mb-12 border-left-primary">
	    <div class="card-body">
			...
			<a class="btn btn-success w-md m-b-5" href="{{url('admin/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
	    </div>
	</div>
        ...
        <div class="card-body">
			<table  id="tb_user" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            <th width="5%">No.</th>
			            <th width="35%">Identitas User</th>
			            <th width="20%">Role</th>
			            <th width="30%">Apotek</th>

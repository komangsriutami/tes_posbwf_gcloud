...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item active" aria-current="page">Setting Role Akses</li>
</ol>
@endsection

@section('content')
{!! Form::model($user, ['method' => 'PUT', 'class'=>'validated_form','id'=>'form-edit', 'route' => ['admin.update_roles_akses', $user->id]]) !!}
	<div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    @include('admin/_form_roles', ['submit_text' => 'Setting Role Akses'])
                </div>

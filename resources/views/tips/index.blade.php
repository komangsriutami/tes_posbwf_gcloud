...
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item active" aria-current="page">Data Tips</li>
</ol>
@endsection
...
@section('content')
	...
	<div class="card card-info card-outline mb-12 border-left-primary">
	    <div class="card-body">
			...
			<a class="btn btn-success w-md m-b-5" href="{{url('tips/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
	    </div>
	</div>
	...
	function edit_data(id){
      	$.ajax({
	        ...
	        beforeSend: function(data){
		        ...
		        $("#modal-xl .modal-title").html("Edit Data - Tips");
		        $('#modal-xl').modal("show");

...
@section('content')
{!! Form::model($role, ['method' => 'PUT', 'class'=>'validated_form','id'=>'form-edit', 'route' => ['role.update', $role->id]]) !!}
    <style type="text/css">
        hr {
            display: block;
            margin: 0px;
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    @include('role/_form', ['submit_text' => 'Update', 'role'=>$role])
                    ...
                    @foreach($menu as $obj)
                        <?php $a++; ?>
                        <div class="form-group col-sm-12">
                            <p class="btn btn-block btn-info"><span><i class="fa fa-fw fa-thumbtack"></i></span> {{ $obj->$nama_singkatan }}</p>
                    ...
                    @endforeach
                    <div class="form-group col-sm-12">
                        <p class="btn btn-block btn-social btn-github"><span><i class="fa fa-fw fa-thumbtack"></i></span> Permission Tanpa Relasi Menu</p>
                        <?php $c = 0; ?>
                        <div class="row">

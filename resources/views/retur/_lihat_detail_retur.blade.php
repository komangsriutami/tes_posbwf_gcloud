                    ...
                    <div class="row">
                        ...
                        <table width="100%">
                            ...
                            <tr class="bg-info">
                                ...
                                <td width="2%"> : </td>
                                <td width="70">{{$detail_penjualan->retur->created_oleh->nama }}</td>
                            </tr>
                            ...
                            <tr>
                                <td width="13%">Dikonfirmasi Tanggal</td>
                                <td width="2%"> : </td>
                                <td width="70">{{ $retur_penjulan->created_at }}</td>
                            </tr>
                            <tr>
                                <td width="13%">Dikonfirmasi Oleh</td>
                                <td width="2%"> : </td>
                                <td width="70">{{ $retur_penjulan->aprove_oleh->nama }}</td>
                            </tr>
                            <?php
                                $btn = '';
                                if($retur_penjulan->is_approved == 0) {
                                    $btn = '<span class="text-info">belum dikonfirmasi</span>';
                                } else if($retur_penjulan->is_approved == 1) {
                                    $btn = '<span class="text-success"></i>telah disetujui</span>';
                                } else if($retur_penjulan->is_approved == 2) {
                                    $btn = '<span class="text-danger"></i>tidak disetujui</span>';
                                }
                            ?>
                            <tr>

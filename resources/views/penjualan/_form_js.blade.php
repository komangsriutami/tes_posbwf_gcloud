		...
		if(is_kredit == 1 && id_vendor == "") {
	        ...
	        if(stok_obat >= jumlah) {
		        var markup = "<tr>"+
		        				...
		        				"<td style='text-align:right;'><input type='hidden' id='detail_penjualan["+counter+"][harga_jual]' name='detail_penjualan["+counter+"][harga_jual]' value='"+harga_jual+"'>" + harga_jual + "</td>"+
		        				"<td style='text-align:right;'><input type='hidden' id='detail_penjualan["+counter+"][diskon]' name='detail_penjualan["+counter+"][diskon]' value='"+diskon+"' class='diskon' data-id-obat='"+id_obat+"'><span class='diskon_label'>"+ diskon +"</span></td>"+
		        				...
		        				"<td><input type='hidden' id='detail_penjualan["+counter+"][jumlah_cn]' name='detail_penjualan["+counter+"][jumlah_cn]' value='0'>0</td>"+
		        				"<td style='display:none;' id='hitung_total_"+counter+"' class='hitung_total' data-total='"+total+"'>" + total + "</td>"+
		        				"<td style='text-align:right;' id='detail_penjualan["+counter+"][total]'><input type='hidden' class='total' data-id-obat='"+id_obat+"' value='"+total+"'><span class='total_label'>" + total + "</span></td>"+
		        			"</tr>";

...
@section('title')
Histori Penjualan Obat
@endsection

@section('breadcrumb')
<ol class="breadcrumb float-sm-right">
    <li class="breadcrumb-item"><a href="#">Transaksi Penjualan</a></li>
    <li class="breadcrumb-item"><a href="#">Histori Penjualan Obat</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_histori_item_penjualan" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
...
<script type="text/javascript">
	...
	var tb_histori_item_penjualan = $('#tb_histori_item_penjualan').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("penjualan/list_pencarian_obat")}}',
			        data:function(d){
				         }
			     },
	        columns: [
	            ...
	            {data: 'is_cn', name: 'is_cn', orderable: true, searchable: true, class:"text-center"}
	        ],

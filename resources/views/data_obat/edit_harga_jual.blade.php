    ...
    <div class="col-sm-12">
        <div class="card card-info card-outline">
            <div class="card-body">
                ...
                <table  id="tb_data_obat_y" class="table table-bordered table-striped table-hover">
                    <thead>
                        <tr>
                            <th width="5%">No.</th>
...
<script type="text/javascript">
    ...
    var tb_data_obat_y = $('#tb_data_obat_y').dataTable( {
            processing: true,
            serverSide: true,
            stateSave: true,
            deferLoading:true,
            scrollX: true,
            ajax:{
                    url: '{{url("data_obat/list_edit_harga_jual")}}',
                    data:function(d){
                        d.id_obat = $("#id").val();
                    }
                 },

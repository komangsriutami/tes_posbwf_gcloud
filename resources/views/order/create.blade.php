...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Nota Order</a></li>
...
{!! Form::model(new App\TransaksiOrder, ['route' => ['order.store'], 'class'=>'validated_form', 'id'=> 'form_order', 'name' => 'form_order']) !!}
    <div class="row" id="divfix">
        <div class="col-sm-12">
            <div class="callout callout-success">
                <a class="btn btn-info text-white" style="text-decoration: none;" type="button" href="{{ url('order')}}" data-toggle="tooltip" data-placement="top" title="List Data Penjualan"><i class="fa fa-home"></i></a> 
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    @include('order/_form', ['submit_text' => 'Create'])
                </div>
            </div>
        </div>
    </div>

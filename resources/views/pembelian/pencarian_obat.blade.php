...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Histori Pembelian Obat</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_histori_item_pembelian" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
...
<script type="text/javascript">
	...
	var tb_histori_item_pembelian = $('#tb_histori_item_pembelian').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("pembelian/list_pencarian_obat")}}',
			        data:function(d){
				         }
			     },
	        columns: [

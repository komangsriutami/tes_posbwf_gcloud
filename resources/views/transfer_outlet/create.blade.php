...
{!! Form::model(new App\TransaksiTO, ['route' => ['transfer_outlet.store'], 'class'=>'validated_form', 'id'=> 'form_to', 'name' => 'form_to']) !!}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card card-info card-outline">
                <div class="card-body">
                    @include('transfer_outlet/_form', ['submit_text' => 'Create'])
                </div>
            </div>
        </div>
    </div>

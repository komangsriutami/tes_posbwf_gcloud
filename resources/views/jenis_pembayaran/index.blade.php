...
@section('content')
	...
	<div class="card card-info card-outline mb-12 border-left-primary">
	    <div class="card-body">
			...
			<a class="btn btn-success w-md m-b-5" href="{{url('jenis_pembayaran/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
	    </div>
	</div>
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_jenis_pembayaran" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            <th width="5%">No.</th>
			            <th width="85%">Jenis Pembayaran</th>
...
<script type="text/javascript">
	...
	var tb_jenis_pembayaran = $('#tb_jenis_pembayaran').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("jenis_pembayaran/list_jenis_pembayaran")}}',
			        data:function(d){
				         }
			     },
	        columns: [
		...
		function(){
			$.ajax({
				...
				success:  function(data){
					if(data==1){
						swal("Deleted!", "Data jenis pembayaran berhasil dihapus.", "success");
					}else{
						
						swal("Failed!", "Gagal menghapus data jenis pembayaran.", "error");
					}
				},
				complete: function(data){
					tb_jenis_pembayaran.fnDraw(false);
				},
				error: function(data) {
	...
	function submit_valid(id){
		if($(".validated_form").valid()) {
			...
			$.ajax({
				...
				success:  function(data){
					if(data.status ==1){
						show_info("Data jenis pembayaran berhasil disimpan!");
	...
	function edit_data(id){
      	$.ajax({
          	type: "GET",
	        url: '{{url("jenis_pembayaran")}}/'+id+'/edit',
	        async:true,
	        data: {
	            _token		: "{{csrf_token()}}",
	        },
	        beforeSend: function(data){
		        ...
		        $("#modal-xl .modal-title").html("Edit Data - Jenis Pembayaran");
		        $('#modal-xl').modal("show");

            ...
            <form role="form" id="searching_form">
            	<div class="row">
                    ...
                    <div class="col-lg-2 form-group">
                        <label>Status</label>
                        <select id="id_status_lunas" name="id_status_lunas" class="form-control input_select">
...
<script type="text/javascript">
	var token = '{{csrf_token()}}';
 	...
 	var tb_faktur = $('#tb_faktur').DataTable( {
        ...
        serverSide: true,
        ajax: {
            url: '{{url("pembelian/list_pembayaran_faktur")}}',
		        data:function(d){
    ...
    function export_pembayaran_faktur(){
        window.open("{{ url('pembelian/export') }}"+ "?id_apotek="+$('#id_apotek').val()+"&id_suplier="+$('#id_suplier').val()+"&id_status_lunas="+$('#id_status_lunas').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
@endsection
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Data Klinik</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline mb-12 border-left-primary">
	    <div class="card-body">
			...
			<a class="btn btn-success w-md m-b-5" href="{{url('klinik/create')}}"><i class="fa fa-plus"></i> Tambah Data</a>
	    </div>
	</div>
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			<table  id="tb_klinik" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            <th>No.</th>
			            <th>Nama</th>
...
<script type="text/javascript">
	...
	var tb_klinik = $('#tb_klinik').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("klinik/list_klinik")}}',
			        data:function(d){
				         }
			     },
	        columns: [
		...
		function(){
			$.ajax({
				...
				success:  function(data){
					if(data==1){
						swal("Deleted!", "Data klinik berhasil dihapus.", "success");
					}else{
						
						swal("Failed!", "Gagal menghapus data klinik.", "error");
					}
				},
				complete: function(data){
					tb_klinik.fnDraw(false);
				},
				error: function(data) {
	...
	function submit_valid(id){
		if($(".validated_form").valid()) {
			...
			$.ajax({
				...
				success:  function(data){
					if(data.status ==1){
						show_info("Data klinik berhasil disimpan!");
	...
	function edit_data(id){
      	$.ajax({
	        ...
	        beforeSend: function(data){
		        ...
		        $("#modal-xl .modal-title").html("Edit Data - Klinik");
		        $('#modal-xl').modal("show");

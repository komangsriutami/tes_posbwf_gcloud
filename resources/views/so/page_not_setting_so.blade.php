...
@section('content')
  ...
  <div class="error-page">
    ...
    <div class="error-content">
      <h3><i class="fas fa-exclamation-triangle text-warning"></i> Oops! Maaf anda belum melakukan setting stok opnam, silakan lakukan setting terlebih dahulu di menu <b>Setting Stok Opnam</b>.</h3>

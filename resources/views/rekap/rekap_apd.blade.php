...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Rekap APD</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			...
			<hr>
			<table  id="tb_data_apd" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            ...
			            <th width="55%" class="text-center">Biaya</th>
...
<script type="text/javascript">
	...
	var tb_data_apd = $('#tb_data_apd').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("penjualan/list_rekap_apd")}}',
			        data:function(d){
			        	d.id         = $('#search_id').val();
	        ...
	        columns: [
	            ...
	            {data: 'biaya_apd', name: 'biaya_apd', orderable: false, searchable: true}
	...
	function export_data(){
        window.open("{{ url('penjualan/export_rekap_apd') }}"+ "?id="+$('#search_id').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
</script>
@endsection
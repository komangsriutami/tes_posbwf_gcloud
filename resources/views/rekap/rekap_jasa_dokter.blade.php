...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Rekap Jasa Dokter</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			...
			<hr>
			<table  id="tb_data_jasa_dokter" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            ...
			            <th width="45%" class="text-center">Dokter</th>
...
<script type="text/javascript">
	...
	var tb_data_jasa_dokter = $('#tb_data_jasa_dokter').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("penjualan/list_rekap_jasa_dokter")}}',
			        data:function(d){
			        	d.id         = $('#search_id').val();
	        ...
	        columns: [
	            ...
	            {data: 'biaya_jasa_dokter', name: 'biaya_jasa_dokter', orderable: false, searchable: true}
	...
	$(document).ready(function(){
		$("#searching_form").submit(function(e){
			e.preventDefault();
			tb_data_jasa_dokter.fnDraw(false);
		});
	...
	function export_data(){
        window.open("{{ url('penjualan/export_rekap_jasa_dokter') }}"+ "?id="+$('#search_id').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
</script>
@endsection
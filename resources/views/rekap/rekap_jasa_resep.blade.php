...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Rekap Jasa Resep</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			...
			<hr>
			<table  id="tb_data_jasa_resep" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            ...
			            <th width="45%" class="text-center">Jasa Resep</th>
...
<script type="text/javascript">
	...
	var tb_data_jasa_resep = $('#tb_data_jasa_resep').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("penjualan/list_rekap_jasa_resep")}}',
			        data:function(d){
			        	d.id         = $('#search_id').val();
	        ...
	        columns: [
	            ...
	            {data: 'id_jasa_resep', name: 'id_jasa_resep'},
	            {data: 'biaya_resep', name: 'biaya_resep', orderable: false, searchable: true}
	...
	$(document).ready(function(){
		$("#searching_form").submit(function(e){
			e.preventDefault();
			tb_data_jasa_resep.fnDraw(false);
		});
	...
	function export_data(){
        window.open("{{ url('penjualan/export_rekap_jasa_resep') }}"+ "?id="+$('#search_id').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
</script>
@endsection
...
<ol class="breadcrumb float-sm-right">
    ...
    <li class="breadcrumb-item"><a href="#">Rekap Laboratorium</a></li>
...
@section('content')
	...
	<div class="card card-info card-outline" id="main-box" style="">
        ...
        <div class="card-body">
			...
			<hr>
			<table  id="tb_data_lab" class="table table-bordered table-striped table-hover">
		    	<thead>
			        <tr>
			            ...
			            <th width="20%" class="text-center">Nama Lab</th>
...
<script type="text/javascript">
	...
	var tb_data_lab = $('#tb_data_lab').dataTable( {
			processing: true,
	        serverSide: true,
	        stateSave: true,
	        ajax:{
			        url: '{{url("penjualan/list_rekap_laboratorium")}}',
			        data:function(d){
			        	d.id         = $('#search_id').val();
	        ...
	        columns: [
	            ...
	            {data: 'keterangan_lab', name: 'keterangan_lab'},
	            {data: 'biaya_lab', name: 'biaya_lab', orderable: false, searchable: true},
	...
	function export_data(){
        window.open("{{ url('penjualan/export_rekap_laboratorium') }}"+ "?id="+$('#search_id').val()+"&tgl_awal="+$('#tgl_awal').val()+"&tgl_akhir="+$('#tgl_akhir').val(),"_blank");
    }
</script>
</script>
@endsection
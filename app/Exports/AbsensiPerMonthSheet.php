...
class AbsensiPerMonthSheet implements FromCollection, WithTitle, WithColumnWidths, WithStyles, WithStartRow
{
    protected $year;
    protected $month;
    ...
    public function __construct(int $year, int $month, int $id_searching_by, int $id_apotek, int $id_user, string $user, $cek_tgl_absen)
    {
        $this->month = $month;
        $this->year  = $year;

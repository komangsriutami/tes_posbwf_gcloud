...
use App\DataTables\StokSGDataTable;
use App\DataTables\StokSGDataTableEditor;
...
class S_SGController extends Controller
{
    ...
    public function store(StokSGDataTableEditor $editor)
    {
